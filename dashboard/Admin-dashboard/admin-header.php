...
<body>
        ...
        <nav class="main-nav">
            <div class="nav-container">
                ...
                <div class="nav-actions">
                    <span class="welcome-user">Welcome, <strong style="color: #90ACE8; ">Admin</strong></span>
                    <div class="nav-icons">
    ...
    <div class="mobile-menu-panel" id="mobileMenuPanel">
        ...
        <div class="mobile-menu-actions">
            <div class="welcome-user-mobile">Welcome, <strong style="color: #90ACE8; ">Admin</strong></div>
