...
$faqs = [
    ...
    "how do i report an electrical, plumbing or any other issue?" => "⚡🚰 Please use the complaint form for electrical, plumbing, or other maintenance issues.",
    "how do i report an electrical issue?" => "⚡🚰 Please use the complaint form for electrical issues.",
    "how do i report a plumbing issue?" => "⚡🚰 Please use the complaint form for plumbing issues.",
